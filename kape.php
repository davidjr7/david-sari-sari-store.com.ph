...
// Static "Kape" products
$kape_products = [
//pede ka mag dagdag ng producs dito kung gusto mo ng display lng 
//kunware ganre     ["id" => 4, "name" => "Kopiko Black", "price" => 55, "image" => "image/black.jpg", "description" => "Strong coffee taste", "quantity" => 8],
];

// AJAX SEARCH HANDLER (ONLY THIS PART CHANGES)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['txt_search'])) {
    $search_term = $_POST['txt_search'];
    $filtered_products = [];
    
    // Filter static products
    foreach ($kape_products as $product) {
...
$sql = "SELECT * FROM products WHERE category = 'Kape' AND status = 'available'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $kape_products[] = [
...
<main class="container-fluid">
    <div class="hero-section">
        ...
        <div class="hero-content">
            <h1>Kape</h1>
            <p>Quality coffee for your daily energy boost</p>
            <!-- Search -->
            <div class="search-section mt-4 mb-5">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="d-flex">
                                <input type="text" class="form-control me-2" id="txt_search" placeholder="Search for coffee...">
    ...
    <div class="container mt-5">
        <div class="section-header">
            <h2 class="section-title">Coffee Selection</h2>
            <div class="divider"></div>
            <p class="section-subtitle">Perfect blends to start your day</p>
        </div>

        <div id="product-container">
            <div class="row g-4 product-grid">
                <?php foreach ($kape_products as $product): ?>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product-card">
