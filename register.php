...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $role = 'client'; // Force role to 'client' only

    // Validate passwords match
    if ($password !== $confirm_password) {
        $error = "Hindi nagtugma ang mga password!";
    } else {
        // Check if username already exists
        $check_user = "SELECT * FROM users WHERE username = '$username'";
        $result = mysqli_query($conn, $check_user);
        if (mysqli_num_rows($result) > 0) {
            $error = "Umiiral na ang username na ito!";
        } else {
            ...
            if (mysqli_query($conn, $query)) {
                $_SESSION['register_success'] = "Matagumpay ang pagrehistro! Mangyaring mag-log in.";
...
<html lang="en">
<head>
    <title>David's Sari-Sari Store - Register</title>
        ...
        <div class="store-container">
            ...
            <div class="store-window">
                ...
                <form method="POST">
                    ...
                    <div class="input-group">
                        <i class="fas fa-lock"></i>
                        <input type="password" name="confirm_password" placeholder="Kumpirmahin ang Password" required>
                    </div>
                    <br>
                    <button type="submit">
                ...
                <div class="register-link">
                    <p>May account ka na? <a href="login.php">Abay mag-login kana dito!</a></p>
                </div>
            </div>
