...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["add_product"])) {
        ...
        if (!in_array($imageFileType, $allowed_types)) {
            ...
            header("Location: editor_manage_products.php");
            exit();
        }
...
<body>
      <div class="col-md-3 col-lg-2 sidebar p-0">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="editor_dashboard.php">
                            Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="editor_manage_products.php">
                            Manage Products
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <form method="POST" enctype="multipart/form-data" class="product-form mb-5 p-4 bg-white rounded shadow-sm">
        ...
        <div class="mt-3">
            <?php if ($edit_product): ?>
                ...
                <a href="editor_manage_products.php" class="btn btn-secondary">Cancel</a>
            <?php else: ?>
    ...
    <div class="filter-section mb-4">
        <form method="GET" class="row g-3">
            ...
            <div class="col-12">
                ...
                <a href="editor_manage_products.php" class="btn btn-outline-secondary">Reset Filters</a>
            </div>
        </form>
    </div>
