...
// Static products with description & quantity
$alak_products = [
//pede ka mag dagdag ng producs dito kung gusto mo ng display lng 
//kunware ganre  ["id" => 1, "name" => "San Miguel Pale Pilsen", "price" => 55, "image" => "image/San Miguel Pale Pilsen.jpg", "description" => "Classic local beer", "quantity" => 20],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['txt_search'])) {
    ...
    foreach ($alak_products as $product) {
...
$sql = "SELECT * FROM products WHERE category = 'Alak' AND status = 'available'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $alak_products[] = [
...
<main class="container-fluid">
    <div class="hero-section">
        ...
        <div class="hero-content">
            <h1>Alak</h1>
            <p>Quality alcoholic beverages for every occasion</p>
            <!-- Search -->
            <div class="search-section mt-4 mb-5">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="d-flex">
                                <input type="text" class="form-control me-2" id="txt_search" placeholder="Search alcoholic drinks...">
    ...
    <div class="container mt-5">
        <div class="section-header">
            <h2 class="section-title">Alcoholic Beverages</h2>
            <div class="divider"></div>
            <p class="section-subtitle">Premium drinks for celebrations and relaxation</p>
        </div>

        <div id="product-container">
            <div class="row g-4 product-grid">
                <?php foreach ($alak_products as $product): ?>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product-card">
